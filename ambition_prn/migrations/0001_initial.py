    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('protocol_violation', 'Protocol violation'), ('protocol_deviation', 'Protocol deviation')], max_length=25, verbose_name='Report type')),
